...
pub use service_path::{
    ...
    WAITER_MOVE_SPEED_Y_MIN_PX_PER_MS, canonical_waiter_walk_speed_y,
    customer_path_duration_ms, customer_path_to_chair, customer_path_to_exit,
    historical_path_signature, is_valid_customer_entrance, path_duration_ms,
    plan_customer_path_to_chair, project_customer_path_to_chair_segment, segment_duration_ms,
