...
pub use service_clock::{
    ...
    SystemServiceTimeSource, TimedServiceCatchUp, TimedServiceTransition, catch_up_timed_service,
    due_service_event, remaining_ms, transition_timed_service, validate_service_deadlines,
};
